...
/**
 * La clase Main es el punto de entrada de la aplicación y contiene el método
 * principal para interactuar con el sistema de gestión de gimnasio.
 * 
...
public class Main {
	...
	/**
	 * El método principal que ejecuta el menú de opciones para interactuar con el
